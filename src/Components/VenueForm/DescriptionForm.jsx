...
const DescriptionForm = () => {
  return (
    <div
      className="Venue-card d-flex justify-content-center align-items-center p-4
      mb-3
    "
    >
      <div className="">
        <h4 className="sub-heading status  " style={{ width: 110 }}>
          Description
        </h4>
        <hr className="g-hr" />
        <span className="form-paragraph pt-2">
          ...
          1,169 square feet. <a href="##"> Read More</a>
        </span>
      </div>
    </div>
  );
